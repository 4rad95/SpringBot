...
CREATE TABLE OpenPosition(id INT AUTO_INCREMENT NOT NULL, time TIMESTAMP, type VARCHAR(5), symbol VARCHAR(20),idBinance VARCHAR(20), stopId VARCHAR(25) NOT NULL , profitId VARCHAR(25) NOT NULL,  profit2Id VARCHAR(25) NOT NULL)
