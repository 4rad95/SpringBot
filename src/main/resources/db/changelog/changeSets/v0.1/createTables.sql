...
CREATE TABLE Symbols (symbols VARCHAR(25) NOT NULL, lowbuy VARCHAR(25) NOT NULL, highbuy VARCHAR(25) NOT NULL, lowsell VARCHAR(25) NOT NULL, highsell VARCHAR(25) NOT NULL );
